class DocumentCollection
  ...
  class Document
    ...
    W = { :order_score => 1.0, :title_score => 1.0, :count_score => 1.0, :special_score => 1.0 }

    attr_accessor :order_score, :title_score, :count_score, :special_score
    attr_accessor :url, :title, :html
    attr_accessor :tokens

    def initialize(url, order_score = 0.0, title_score = 0.0, count_score = 0.0, special_score = 0.0)
      @url = url
  ...
  def add_doc_count_score(url, count_score)
    @docs[url].count_score = count_score.to_f
    @min_count_score = [@min_count_score, count_score].min.to_f
    @max_count_score = [@max_count_score, count_score].max.to_f
  end
